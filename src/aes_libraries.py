...
class sbox:
    """
    Minimal class to support S-Box lookups. Taken from an external library here:

    https://gist.github.com/henrique-marcomini-movile/b746b398b8b942a9366eb1636c04ac85
    """
    sbox_table = [
